...
const TOOL_DEFINITIONS: ToolDef[] = [
  ...
  },
  {
    ...
    defaultValue: 0,
    accent: "#10b981",
    format: (v) => `${Math.round(v)}% Bokeh`,
  },
  {
    key: "focusDistance",
    label: "Plan de Focus (0=Avant / 100=Arrière)",
    category: "effects",
    min: 0,
    max: 100,
    step: 1,
    defaultValue: 30,
    accent: "#06b6d4",
    format: (v) => (v < 25 ? "Avant-Plan" : v < 70 ? "Mi-Distance" : "Arrière-Plan"),
  },
  {
    key: "apertureFStop",
    label: "Ouverture F-Stop",
    category: "effects",
    min: 1.2,
    max: 16.0,
    step: 0.2,
  ...
  // Exotiques & Scientifiques
  {
    key: "jwstSpikes",
    label: "JWST Diffraction 6-Point",
    category: "curious",
    min: 0,
    max: 100,
    step: 1,
    defaultValue: 0,
    accent: "#fbbf24",
    format: (v) => `${Math.round(v)}% Spikes`,
  },
  {
    key: "kirlianAura",
    label: "Kirlian Plasma Corona",
    category: "curious",
    min: 0,
    max: 100,
    step: 1,
    defaultValue: 0,
    accent: "#d946ef",
    format: (v) => `${Math.round(v)}% Aura`,
  },
  {
    key: "lidarMesh",
    label: "LiDAR Spatial 3D",
    category: "curious",
    min: 0,
    max: 100,
    step: 1,
    defaultValue: 0,
    accent: "#06b6d4",
    format: (v) => `${Math.round(v)}% Mesh`,
  },
  {
    key: "quantumEvent",
    label: "Trou Noir EHT Relativiste",
    category: "curious",
    min: 0,
    max: 100,
    step: 1,
    defaultValue: 0,
    accent: "#f97316",
    format: (v) => `${Math.round(v)}% Lensing`,
  },
  {
    key: "solarHAlpha",
    label: "Solaire H-Alpha 656nm",
    category: "curious",
    min: 0,
    max: 100,
    step: 1,
    defaultValue: 0,
    accent: "#ef4444",
    format: (v) => `${Math.round(v)}% Plasma`,
  },
  {
    key: "electronMicro",
    label: "Microscope SEM 20kV",
    category: "curious",
    min: 0,
    max: 100,
    step: 1,
